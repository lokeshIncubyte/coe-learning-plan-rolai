...
describe('PicsumLabPage integration', () => {
  ...
  it('adds grayscale to preview image URL when the grayscale checkbox is toggled on', async () => {
    vi.spyOn(globalThis, 'fetch').mockResolvedValue({
      json: async () => [
        {
          id: '0',
    ...
    expect(previewImage).toHaveAttribute('src', expect.stringContaining('grayscale'))
  })

  it('adds blur to preview image URL when the blur checkbox is toggled on', async () => {
    vi.spyOn(globalThis, 'fetch').mockResolvedValue({
      json: async () => [
        {
          id: '0',
    ...
    expect(previewImage).toHaveAttribute('src', expect.stringContaining('blur'))
  })
